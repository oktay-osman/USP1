			...
			<div class="shell">
				<div class="section__head">
					<div class="section__title">
						<h1>All income categories by price</h1>
					</div>
				</div>
				...
				<div class="section__content">
					<?php 
						...
						$user_id = $_SESSION['user_id'];
							...
							$sql = "SELECT category_name, SUM(value), COUNT(id_income) FROM incomes
							JOIN categories_incomes ON id_category = category_id
