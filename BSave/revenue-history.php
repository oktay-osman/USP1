		...
		<div class="section-history" id="history">
			<div class="shell">
				<div class="section__title">
					<h1>History of all <span>incomes</span> you have added</h1>
				</div>
				...
				<div class="section__content">
					<?php
						...
						$sql =  "SELECT * FROM incomes
								JOIN categories_incomes ON categories_incomes.id_category=incomes.category_id
						...
						while($row = mysqli_fetch_assoc($result)){
							echo "<tr>
									...
									<td>".$row['ddate']."</td>
									<td><a href='#' id='delete-income' data-id=".$row['id_income']." onclick='Delete()'>&#10008;</a></td>
								</tr>";
